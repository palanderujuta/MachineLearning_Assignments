...
load MNIST_digit_data
    indices1 = find(labels_train(:, 1) == 1 );%| labels_train(:, 1) == 6);
    sample1 = indices1(randsample(1:6000,500),:)  ;
    images_train1 = images_train(sample1, :);
    labels_train1 = labels_train(sample1);
    indices2 = find(labels_train(:, 1) == 6 );%| labels_train(:, 1) == 6);
    sample2 = indices2(randsample(1:5000,500),:)  ;
    images_train2 = images_train(sample2, :);
    labels_train2 = labels_train(sample2);
    images_train=[images_train1;images_train2];
