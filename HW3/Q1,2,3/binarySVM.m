...
[weight1,accuracy1] = SVM(train_images1,train_labels1,test_images1,test_labels1,1,0.00001);
figure();
plot (accuracy1);
title('Accuracy with unsorted training and a very small C')
xlabel('data');
ylabel('accuracy');

[weight1,accuracy1] = SVM(train_images1,train_labels1,test_images1,test_labels1,1,10);
figure();
plot (accuracy1);
title('Accuracy with unsorted training and a very large C')
xlabel('data');
ylabel('accuracy');
